...
impl DdexIngestionStorage {
    ...
    pub fn build(aws_main_config: &aws_config::SdkConfig) -> Result<Self> {
        Ok(Self {
            ...
            bucket_name: Self::get_env_var("MESSAGES_BUCKET_NAME"),
            input_files_dir: Self::get_env_var("INPUT_FILES_DIR"),
            message_bucket_prefix: Self::get_env_var("MESSAGE_BUCKET_PREFIX"),
            fallback_bucket_name: Self::get_env_var("FALLBACK_BUCKET_NAME"),
