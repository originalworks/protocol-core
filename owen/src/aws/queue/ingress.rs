...
impl DdexIngestionQueue {
    ...
    pub fn build(aws_main_config: &aws_config::SdkConfig) -> Result<Self> {
        Ok(Self {
            ...
            table_name: Self::get_env_var("MESSAGE_STATUS_TABLE_NAME"),
            index_name: Self::get_env_var("PROCESSING_STATUS_INDEX_NAME"),
            pk_name: Self::get_env_var("MESSAGE_FOLDER_ATTRIBUTE_NAME"),
            processing_status_attribute_name: Self::get_env_var("PROCESSING_STATUS_ATTRIBUTE_NAME"),
            owen_instance_attribute_name: Self::get_env_var("OWEN_INSTANCE_ATTRIBUTE_NAME"),
            unprocessed_status_value: Self::get_env_var("UNPROCESSED_STATUS_VALUE"),
            processed_status_value: Self::get_env_var("PROCESSED_STATUS_VALUE"),
            reserved_status_value: Self::get_env_var("RESERVED_STATUS_VALUE"),
            rejected_status_value: Self::get_env_var("REJECTED_STATUS_VALUE"),
            owen_instance_name: Self::get_env_var("USERNAME"),
        })
    }
